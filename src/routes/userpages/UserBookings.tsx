...
import { resetForm, updateField } from "./formSlice";
import { persistor, reduxStore, RootState } from "../../store";
...
export const UserBookings = () =>  {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.guestCount || formData.guestCount < 0) newErrors['guestCount'] = true;
    ...
    <div className="w-screen flex flex-col justify-start">
      <div className="flex flex-col justify-center items-center">
        ...
        <CalendarComponent 
          ...
          contextSelectedDate={formData.eventDate} 
        />
      </div>
